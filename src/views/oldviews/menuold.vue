<!-- <template>
  <div class="app-container">
    ...
    <el-table :data="dataList" row-key="id" border size="small" style="width: 100%; ">
      <el-table-column prop="resourceName" header-align="center" label="名称" />
      <el-table-column prop="resourceKey" header-align="center" align="center" :show-overflow-tooltip="true" width="200"
        label="授权标识" />
      <el-table-column prop="resourceUrl" header-align="center" align="center" :show-overflow-tooltip="true" label="链接" />
      <el-table-column prop="resourceUrl" header-align="center" align="center" label="图标">
      ...
      <el-table-column prop="resourceLevel" header-align="center" align="center" width="80" label="排序号" />
      <el-table-column v-if="isAuth('sys:menu:update')||isAuth('sys:menu:delete')" header-align="center" align="center"
        width="150" label="操作">
        <template slot-scope="scope">
